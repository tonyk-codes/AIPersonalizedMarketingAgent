...
def main() -> None:
    ...
    with st.sidebar:
        ...
        product = PRODUCT_MAP[str(product_name)] if product_name else list(PRODUCT_MAP.values())[0]
    ...
    customer = Customer(str(name), int(age), str(gender), str(nationality), str(location))
